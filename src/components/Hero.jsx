...
const HireActionPerform = ()=>{
  ...
  return (
    <div className="flex items-center justify-center flex-wrap mt-10">
          ...
          <div className="bg-[var(--main-bg)] sm:w-[70vw] w-[70%] text-white min-h-[80vh] flex items-center justify-center sm:justify-between px-10 sm:px-20 rounded-2xl flex-wrap">
                <div className="">
                    <img className="w-[25vw] max-sm:w-[60vw] rounded-2xl" src="./img/bharat.png" alt="" />
                </div>

              <div className="flex flex-col items-start pr-10 gap-10">
                    <div className="flex flex-col gap-4">
                        ...
                        <h1 className="sm:text-7xl font-bold">Bharat Patell</h1>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <p className="text-sm text-[var(--p-text)] font-medium">
                              From Jodhpur, Rajasthan. I have rich experience in web design,<br/> also I
                              am good at problem Solving Skills. I love to talk with you <br /> about our unique
                              </p>
                              
                      </div>

                      <div className="flex gap-4">
                        <button className="bg-orange-500 px-7 text-black font-bold py-4 rounded-full cursor-pointer text-xs" onClick={handleDownload} >Download CV</button>
